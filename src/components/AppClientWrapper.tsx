// AppClientWrapper.tsx - Fixed Hydration Error + Accessibility
  ...
  return (
    <>
      ...
      >
        ...
        {/* 🎯 Footer - เปลี่ยนจาก footer tag เป็น div */}
          ...
          <section className="newsletter-section">
            ...
            <div className="footer-logo-social">
              <Image
                ...
                alt="Unda Alunda logo featuring stylized cat silhouette"
                width={120}
                height={120}
                quality={100}
                loading="lazy"
              ...
              <div className="social-icons mb-6">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  aria-label="Subscribe to Unda Alunda YouTube channel"
                >
                  <YoutubeIcon />
                </a>
                <a 
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  aria-label="Follow Unda Alunda on Twitter"
                >
                  <TwitterIcon />
                </a>
                <a 
            ...
            <div className="newsletter-form-wrapper mb-0">
              <h3 className="sr-only">Newsletter Signup</h3>
              <NewsletterForm />
            </div>

            <div className="footer-bottom mt-5 text-center">
              <nav className="footer-links flex flex-wrap justify-center items-center gap-2 text-sm text-[#f8fcdc]/80 tracking-wide" aria-label="Footer navigation">
                <Link 
                  href="/shipping-and-returns" 
                  className="hover:text-[#dc9e63] transition-colors duration-200"
                  aria-label="Read shipping and returns policy"
                >
                  SHIPPING & RETURNS
                </Link>

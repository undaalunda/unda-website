...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      setScrolledDown(currentScrollY > 50);
  ...
  // 🎯 ตรวจสอบว่าควรใช้ layout แบบซ้าย หรือกลาง - sync กับ navbar background
  const shouldUseLeftLayout = isHomepage && !searchOpen && !scrolledDown;

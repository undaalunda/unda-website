/* NewsletterForm.tsx - แก้ไข React warnings */
...
export default function NewsletterForm() {
  ...
  // Handler สำหรับการเปลี่ยนแปลงของ input
  ...
  // ลบ useEffect ออกทั้งหมด ให้ใช้ HTML form submission ปกติ
